...
class InferYolo26Widget(core.CWorkflowTaskWidget):
    def __init__(self, param, parent):
        ...
        if param is None:
            self.parameters = InferYolo26Param()
        else:
        ...
        self.combo_model.addItem("yolo26n")
        self.combo_model.addItem("yolo26s")
        self.combo_model.addItem("yolo26m")
        self.combo_model.addItem("yolo26l")
        self.combo_model.addItem("yolo26x")
...
class InferYolo26WidgetFactory(dataprocess.CWidgetFactory):
    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        self.name = "infer_yolo_26"

    def create(self, param):
        return InferYolo26Widget(param, None)
